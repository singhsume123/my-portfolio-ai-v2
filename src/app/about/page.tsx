  ...
  return (
    <main className="min-h-screen bg-white text-neutral-900">
      <div className="mx-auto flex max-w-4xl flex-col gap-12 px-6 py-16 sm:py-20">
        ...
        <section className="grid gap-6 rounded-2xl border border-neutral-200 bg-white p-8 shadow-sm sm:grid-cols-2">
          <div className="space-y-3">
            <h3 className="text-xl font-semibold">AI for Quality</h3>
            <p className="text-neutral-700">
          ...
          <div className="space-y-3">
            <h3 className="text-xl font-semibold">Android Performance</h3>
            <p className="text-neutral-700">
